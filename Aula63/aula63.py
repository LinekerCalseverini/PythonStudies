...
cpf_entrada = input('Digite um CPF: ')
cpf = re.sub(r'[^0-9]', '', cpf_entrada)[:9]

soma = 0
indice = 10

cpf_entrada_e_sequencial = cpf_entrada == cpf_entrada[0] * len(cpf_entrada)
...
digito_cpf_entrada = cpf_entrada[:9]
