...
from typing import (
    List, Union, Tuple, Dict, NewType, Callable, Sequence, Iterable
)
...
def iterar(sequencia: Sequence[int]) -> Sequence[int]:
    return [x for x in sequencia]


def iterar2(sequencia: Iterable[int]) -> Iterable[int]:
    return [x for x in sequencia]
