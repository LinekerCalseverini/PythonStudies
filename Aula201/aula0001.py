...
# - A seção original desse curso usou PyQt5 (estamos atualizando PySide6)
...
#   público.
#   Licenças são tópicos complexos, se oriente sobre elas
#   antes de usar qualquer software de terceiros.
#   https://tldr.com/license/gnu-lesser-general-public-license-v3-(lgpl-3)
